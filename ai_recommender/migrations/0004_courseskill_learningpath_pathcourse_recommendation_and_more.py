# Generated by Django 6.0 on 2026-01-03 06:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ai_recommender', '0003_skill_userskill_delete_embedding_and_more'),
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='userskill',
            options={'ordering': ['-proficiency', '-last_practiced_at']},
        ),
        migrations.AddField(
            model_name='skill',
            name='created_at',
        ...
        migrations.AddField(
            ...
            field=models.FloatField(default=0.0, help_text='Calculated based on course enrollments'),
        ),
        migrations.AddField(
            model_name='skill',
            name='slug',
            field=models.SlugField(default=0, max_length=120, unique=True),
        ...
        migrations.AddField(
            model_name='userskill',
            name='source',
            field=models.CharField(choices=[('course', 'Course Completion'), ('manual', 'Self-Reported'), ('assessment', 'Assessment Result'), ('imported', 'Imported Profile')], default='course', max_length=50),
        ),
        migrations.AlterField(
            model_name='skill',
            name='category',
            field=models.CharField(choices=[('technical', 'Technical'), ('creative', 'Creative'), ('business', 'Business'), ('language', 'Language'), ('personal', 'Personal Development'), ('science', 'Science & Math'), ('other', 'Other')], default='other', max_length=50),
        ),
        migrations.AlterField(
            model_name='skill',
            name='name',
        ...
        migrations.AlterField(
            model_name='userskill',
            name='proficiency',
            field=models.FloatField(default=0.0, help_text='Skill level: 0-100', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(100.0)]),
        ),
        migrations.AlterField(
            model_name='userskill',
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_skills', to='ai_recommender.skill'),
        ),
        migrations.AlterField(
            model_name='userskill',
            name='user',
        ...
        migrations.AddIndex(
            model_name='skill',
            index=models.Index(fields=['category', '-popularity_score'], name='ai_recommen_categor_e19e2e_idx'),
        ),
        migrations.AddIndex(
            model_name='skill',
            index=models.Index(fields=['is_active', '-popularity_score'], name='ai_recommen_is_acti_e7abd4_idx'),
        ),
        migrations.AddIndex(
            model_name='userskill',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_skills', to='courses.course'),
        ),
        migrations.AddField(
            model_name='courseskill',
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_mappings', to='ai_recommender.skill'),
        ),
        migrations.AddField(
            model_name='learningpath',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_paths', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='learningpath',
        ...
        migrations.AddField(
            model_name='pathcourse',
            name='learning_path',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='path_courses', to='ai_recommender.learningpath'),
        ),
        migrations.AddField(
            model_name='learningpath',
            name='courses',
        ...
        migrations.AddField(
            model_name='recommendation',
            name='matched_skills',
            field=models.ManyToManyField(blank=True, related_name='recommendations', to='ai_recommender.skill'),
        ),
        migrations.AddField(
            model_name='recommendation',
            name='user',
        ...
        migrations.AddField(
            ...
            name='target_skills',
            field=models.ManyToManyField(related_name='required_for_roles', to='ai_recommender.skill'),
        ),
        migrations.AddField(
            model_name='skillgapanalysis',
            name='user',
        ...
        migrations.AddField(
            ...
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trending_data', to='ai_recommender.skill'),
        ),
        migrations.AddField(
            model_name='userinterest',
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interested_users', to='ai_recommender.skill'),
        ),
        migrations.AddField(
            model_name='userinterest',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='path_completions', to='courses.course'),
        ),
        migrations.AddField(
            model_name='userlearningpath',
            name='learning_path',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='ai_recommender.learningpath'),
        ),
        migrations.AddField(
            model_name='userlearningpath',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrolled_paths', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='courseskill',
        ...
        migrations.AddIndex(
            model_name='recommendation',
            index=models.Index(fields=['user', 'status', '-score'], name='ai_recommen_user_id_a3cc24_idx'),
        ),
        migrations.AddIndex(
            model_name='recommendation',
            index=models.Index(fields=['user', '-created_at'], name='ai_recommen_user_id_041490_idx'),
        ),
        migrations.AddIndex(
            model_name='recommendation',
            index=models.Index(fields=['algorithm', '-score'], name='ai_recommen_algorit_186b61_idx'),
        ),
        migrations.AddIndex(
            model_name='skillgapanalysis',
